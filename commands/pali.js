...
module.exports = {
    ...
    execute(message, args) {
      ...
      if (msg.includes('help')){
        ...
        +"Otherwise, maybe it's a bug. If you want to see it fixed, please pm [BimoIch](https://discordapp.com/channels/@me/385751842380054528) on Discord **Please note that due to finiancial issues, the bot might be offline last days of every months**")
        .addField("My initial source code provided by [/u/yasefumi] on reddit.")
  		  .addBlankField(true)
